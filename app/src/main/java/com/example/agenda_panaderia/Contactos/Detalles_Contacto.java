...
public class Detalles_Contacto extends AppCompatActivity {

    ImageView Imagen_C_D, regresar2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regresar2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(Detalles_Contacto.this, Listar_Contactos.class);
    ...
    private void ObtenerImagen(){
        ...
        try {
            ...
            Glide.with(getApplicationContext()).load(imagen).placeholder(R.drawable.imau).into(Imagen_C_D);
