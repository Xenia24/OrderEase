...
public class Detalle_Pedido extends AppCompatActivity {
        ...
        FirebaseUser user;
        Button Importantes;
        boolean comrprobarimportante=false;
        @Override
...
//r
        ...
        private void SetDatosR(){
            ...
            //Forma_Pedido.setText(fecha_pedido);
        ...
        private void pedidos_importantes() {
            if (user == null) {
                ...
                Pedido_importante.put("fecha_actual", fecha_registro);
                ...
                DatabaseReference reference= FirebaseDatabase.getInstance().getReference("Contactos");
        ...
        private void Verificarimportante(){
            if(user==null){
                ...
                DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference("Contactos");
                databaseReference.child(firebaseAuth.getUid()).child("Mis pedidos importantes").child(ident_pedido_importante).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        comrprobarimportante = snapshot.exists();
                        if(comrprobarimportante){
                            String importante="Importante";
                            Importantes.setCompoundDrawablesRelativeWithIntrinsicBounds(0,R.drawable.importante, 0,0);
                            Importantes.setText(importante);
                        }else{
                            String no_importante="No importante";
                            Importantes.setCompoundDrawablesRelativeWithIntrinsicBounds(0,R.drawable.importante2, 0,0);
                            Importantes.setText(no_importante);
                        }
                    }
